...
| :--- | :--- | :--- | :--- |
| **Week 1** | JS Basics | Variables, Operators, Core Functions | [View](./Week1_Assignments) |
| **Week 2** | Advanced JS | Objects, Async/Await, ES6+ Features | [View](./Week2_Assignments) |
| **Week 3** | Backend Foundations | Node.js, Express, Middlewares | [View](./Week3_Assignments) |
| **Week 4** | Web Layouts | HTML/CSS Fundamentals, Pochi the Cat | [View](./Week4_Assignments) |
| **Week 5** | Responsive Design | Flexbox, Grid, Modern Layouts | [View](./Week5_Assignments) |
| **Week 6** | Frontend Mastery | React Context, Hooks, State Management | [View](./Week6_Assignments) |
